...
<div class="wrap pmpro_admin">	
	<div class="pmpro_banner">
		<a class="pmpro_logo" title="Paid Subscriptions - Membership Plugin for WordPress" target="_blank" href="<?php echo pmpro_https_filter("http://www.paidmembershipspro.com")?>"><img src="<?php echo PMPRO_URL?>/images/Paid-Subscriptions.png" width="350" height="75" border="0" alt="Paid Subscriptions(c) - All Rights Reserved" /></a>	
