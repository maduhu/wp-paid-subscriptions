...
?>
	...
	<form action="" method="post" enctype="multipart/form-data"> 
		...
		<p><?php _e('To modify the appearance of system generated emails, add the files <em>email_header.html</em> and <em>email_footer.html</em> to your theme\'s directory. This will modify both the WordPress default messages as well as messages generated by Paid Subscriptions. <a title="Paid Subscriptions - Member Communications" target="_blank" href="https://github.com/Seravo/wp-paid-subscriptions">Click here to learn more about Paid Subscriptions emails</a>.', 'pmpro');?></p>
		...
		<tbody>                
			...
			<tr>
				...
				<td>
					...
					<?php printf( __('If unchecked, all emails from "%s &lt; %s &gt;" will be filtered to use the above settings.', 'pmpro'), $from_name, $default_from_email) ;?>
				</td>
			</tr>
		</tbody>
		</table>
